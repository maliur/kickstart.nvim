...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        lua = { 'stylua', 'stylua', stop_after_first = true },
        javascript = { 'prettierd', 'prettierd', stop_after_first = true },
        typescript = { 'prettierd', 'prettierd', stop_after_first = true },
        typescriptreact = { 'prettierd', 'prettierd', stop_after_first = true },
        go = { 'gofmt', 'gofmt', stop_after_first = true },
      },
    },
  },
...

  {
    'stevearc/oil.nvim',
    config = function()
      vim.keymap.set('n', '<leader>-', require('oil').open_float, { desc = 'Oil: toggle float' })
